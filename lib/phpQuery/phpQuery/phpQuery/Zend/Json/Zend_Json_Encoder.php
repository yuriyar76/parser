...
namespace Query\phpQuery\Zend\Json;

use Query\phpQuery\Zend\Json\Zend_Json_Exception;
use ReflectionClass;
...
class Zend_Json_Encoder
{
     ...
     * @throws \Query\phpQuery\Zend\Json\Zend_Json_Exception
     */
    ...
    public static function encodeClasses(array $classNames, $package = '')
    {
        ...
        foreach ($classNames as $className) {
            ...
            } catch (\Query\phpQuery\Zend\Json\Zend_Json_Exception $e) {
