...
namespace Query\phpQuery\Zend\Http;


use Query\phpQuery\Zend\Http\Client\Zend_Http_Client_Exception;
use Query\phpQuery\Zend\Uri\Zend_Uri_Exception;
use Query\phpQuery\Zend\Uri\Zend_Uri_Http;
use Query\phpQuery\Zend\Zend_Exception;
use Query\phpQuery\Zend\Zend_Loader;
use Query\phpQuery\Zend\Zend_Uri;
...
use Query\phpQuery\Zend\Http\Zend_Http_Exception;
...
class Zend_Http_Client
{
     ...
     * @throws Zend_Http_Client_Exception
     * @throws \Query\phpQuery\Zend\Uri\Zend_Uri_Exception
     ...
     * @return Zend_Http_Client
     * @throws Zend_Http_Client_Exception
     * @throws \Query\phpQuery\Zend\Http\Zend_Http_Exception
     * @throws \Zend_Uri_Exception
     */
